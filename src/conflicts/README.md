...
The module compares stored source states against current vault state for Markdown, HTML, and ODT. When multiple sources have changed or a rich file disappears, it writes timestamped conflict copies under the rich-document folder and marks the mapping conflicted.
...
- `copies/copies.ts` writes conflict copies for existing Markdown, HTML, ODT, and optional desktop HTML sources.
