...
- Make unsupported desktop-only content read-only or visibly protected.
...
- Test protected raw blocks cannot be accidentally edited as normal text.
...
- Verify in MCP:
  ...
  - Protected unsupported blocks are visible and safe.
